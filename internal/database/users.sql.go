...
const welcomeToChirpy = `-- name: WelcomeToChirpy :exec
UPDATE users
SET is_chirpy_red = true
WHERE id = $1
`

func (q *Queries) WelcomeToChirpy(ctx context.Context, id uuid.UUID) error {
	_, err := q.db.ExecContext(ctx, welcomeToChirpy, id)
	return err
}
